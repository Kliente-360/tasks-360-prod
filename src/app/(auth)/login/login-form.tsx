...
export function LoginForm() {
  ...
  return (
    <div>
      <div className="font-brand text-2xl font-semibold mb-6 text-ink">Entrar</div>
      ...
      <div className="border-t border-line pt-5">
        <div className="text-[10px] uppercase tracking-[0.16em] text-muted font-mono mb-2.5">
      ...
      <div className="text-[11px] text-muted mt-6 leading-relaxed">
        Não está cadastrado?{' '}
